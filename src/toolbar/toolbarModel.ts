...
export type SystemFamilyTool = 'block' | 'branch' | 'loop' | 'async-region' | 'behaviorTree' | 'code' | 'pill' | 'callout'
...
const SYSTEM_TOOLS: readonly SystemFamilyTool[] = ['block', 'branch', 'loop', 'async-region', 'behaviorTree', 'code', 'pill', 'callout']
