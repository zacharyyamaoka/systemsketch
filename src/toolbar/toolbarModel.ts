...
export type SystemFamilyTool = 'block' | 'branch' | 'loop' | 'behaviorTree' | 'code' | 'pill' | 'type' | 'callout'
...
const SYSTEM_TOOLS: readonly SystemFamilyTool[] = ['block', 'branch', 'loop', 'behaviorTree', 'code', 'pill', 'type', 'callout']
