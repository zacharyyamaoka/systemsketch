...
/** The system-design family under the Block slot: nodes, regions, code, values, types, free ports, and Callouts. */
export type SystemFamilyTool = 'block' | 'branch' | 'loop' | 'async-region' | 'behaviorTree' | 'code' | 'pill' | 'type' | 'floating-port' | 'callout'
...
const SYSTEM_TOOLS: readonly SystemFamilyTool[] = ['block', 'branch', 'loop', 'async-region', 'behaviorTree', 'code', 'pill', 'type', 'floating-port', 'callout']
