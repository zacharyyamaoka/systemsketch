...
/** The system-design family under the Block slot: Blocks, regions, values, Types, Code, and Callouts. */
export type SystemFamilyTool = 'block' | 'branch' | 'loop' | 'code' | 'pill' | 'type' | 'callout'
...
const SYSTEM_TOOLS: readonly SystemFamilyTool[] = ['block', 'branch', 'loop', 'code', 'pill', 'type', 'callout']
