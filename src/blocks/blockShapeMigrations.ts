...
/** v7 → v8: a Type body is optional, so old Blocks need no new stored value. */
export function upgradeBlockPropsV7ToV8(props: BlockMigrationProps): BlockMigrationProps {
	return props
}

/** v8 → v7: older readers do not know the Type attribute source. */
...
export const blockShapeMigrations = createShapePropsMigrationSequence({
	sequence: [{
		...
		id: blockVersions.AttributeSource,
