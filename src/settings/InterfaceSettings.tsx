...
type SettingsCategoryId = 'general' | 'canvas' | 'connections' | 'appearance' | 'interface' | 'shortcuts' | 'about'
...
const OPEN_CATEGORIES: readonly SettingsCategoryId[] = ['general', 'appearance', 'canvas', 'connections', 'interface', 'shortcuts']
