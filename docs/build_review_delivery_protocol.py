...
<figure class="card hero"><img src="{media_reference}" alt="Diagram of the terminal review card with Board and Report view links"><figcaption class="caption">Architecture diagram, not a screenshot: below the review title, the terminal shows only the artifact and its short view link.</figcaption></figure>
