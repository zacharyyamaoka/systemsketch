...
<figure class="card hero"><img src="{media_reference}" alt="Diagram of the terminal review card with Read and Explore purpose lanes"><figcaption class="caption">Architecture diagram, not a screenshot: a blank line brackets the review card; its two lanes distinguish reading committed evidence from launching an interactive surface.</figcaption></figure>
<section class="facts"><div class="fact"><b>1 command</b><span>the only final opening gesture</span></div><div class="fact"><b>2 purpose lanes</b><span>read evidence, explore live work</span></div><div class="fact"><b>0 capture blobs</b><span>in the tracked report page</span></div></section>
...
<section class="two"><article class="card"><h2>What changed</h2><ul><li><code>--report-media</code> is constrained to the ignored media namespace and copied safely before a cold start.</li><li>An optional <code>--report-builder</code> runs in the pinned worktree with output and media paths supplied as environment variables.</li><li>The terminal groups a report under <em>Read</em> and a board under <em>Explore</em>, while OSC-8 links still carry short <em>view</em> and <em>launch</em> actions.</li></ul></article><article class="card"><h2>What a handoff omits</h2><ul><li>No “Open it” table.</li><li>No <code>file://</code> report link or percent-encoded board URL.</li><li>No runtime status, version, media, builder, or restart ceremony in the terminal card.</li></ul></article></section>
