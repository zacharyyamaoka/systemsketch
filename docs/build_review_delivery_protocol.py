...
<figure class="card hero"><img src="{media_reference}" alt="Diagram of the terminal review card with informative board and report links"><figcaption class="caption">Architecture diagram, not a screenshot: a blank line brackets the review card, and each row names the artifact before its short action link.</figcaption></figure>
