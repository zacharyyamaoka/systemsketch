---
title: LabVIEW, Blueprint & Simulink gap analysis — revision history
date: 2026-09-04
status: durable research lineage
---

# LabVIEW, Blueprint & Simulink gap analysis — revision history

This directory freezes the exact research pages Zach saw. Older revisions are
never regenerated in place.

1. [R1 — original narrative report (`01f2f30`)](r1-original-01f2f30.html) · [Markdown](r1-original-01f2f30.md)
2. [R2 — first dictionary report (`acc1663`)](r2-dictionary-acc1663.html) · [Markdown](r2-dictionary-acc1663.md)
...
deferred, already present, or deliberately skipped.
