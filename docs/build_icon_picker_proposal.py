...
<section id="prior-art">
  ...
  <table><thead><tr><th>Reference</th><th>What it is</th><th>Take</th></tr></thead><tbody>
    ...
    <tr><th>frimousse · emoji-mart</th><td>Emoji pickers; frimousse is headless but loads its data from a CDN by default; emoji-mart’s React 19 story is a fork.</td><td><span class="tag no">skip</span> the grid is shared with Icons; data is a 45 KB gz JSON, offline</td></tr>
...
<section id="decisions">
  ...
  <div class="decision"><b class="q">D4 · Emoji tab</b><div class="d">It is in Notion and it is cheap (45 KB gz, shared grid), but it is a second visual language on a technical whiteboard. <div class="default">Default: include it, Notion order (Emoji first).</div></div></div>
