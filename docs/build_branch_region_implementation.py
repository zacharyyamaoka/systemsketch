...
<svg viewBox="0 0 1100 420" xmlns="http://www.w3.org/2000/svg" font-family="Inter,ui-sans-serif,system-ui" font-size="14">
  ...
  <g fill="#0c1321" stroke="#39465e">
    ...
    <rect x="330" y="30" width="250" height="310" rx="14" stroke="#70a8ff"/>
    <rect x="670" y="30" width="200" height="70" rx="12"/>
    <rect x="670" y="150" width="200" height="70" rx="12"/>
    <rect x="670" y="270" width="200" height="70" rx="12"/>
    <rect x="910" y="150" width="170" height="70" rx="12" stroke="#ffad57"/>
  </g>
  <g fill="#f8fafc" font-weight="700">
    ...
    <text x="455" y="60" text-anchor="middle">branchCommands.ts</text>
    <text x="770" y="58" text-anchor="middle">BranchShapeUtil</text>
    <text x="770" y="178" text-anchor="middle">blockPorts.ts</text>
    <text x="770" y="298" text-anchor="middle">blockVisibility.ts</text>
    <text x="995" y="178" text-anchor="middle">tldraw 5.3.2</text>
  </g>
  <g fill="#a8b3c7">
    ...
    <text x="455" y="90" text-anchor="middle">one public mutation per gesture</text>
    <text x="455" y="130" text-anchor="middle">addControl · addArm · fold · active · view</text>
    <text x="455" y="160" text-anchor="middle">children keep their arm offset</text>
    <text x="455" y="200" text-anchor="middle">branchModel.ts (pure)</text>
    <text x="455" y="222" text-anchor="middle">layout · transitions · reconcile</text>
    <text x="455" y="262" text-anchor="middle">branchScope.ts (read)</text>
    <text x="455" y="284" text-anchor="middle">arm of child · fold attach · fade</text>
    <text x="455" y="320" text-anchor="middle">meta.branchArm stamped per child</text>
    <text x="770" y="80" text-anchor="middle">BaseFrameLikeShapeUtil</text>
    <text x="770" y="200" text-anchor="middle">port host = Block | Branch</text>
    <text x="770" y="320" text-anchor="middle">getShapeVisibility</text>
    <text x="995" y="200" text-anchor="middle">stock, unforked</text>
  </g>
  <g stroke="#70a8ff" stroke-width="2" fill="none" marker-end="url(#a)">
    <path d="M240 65 H330"/><path d="M240 185 H330"/><path d="M240 305 H330"/>
    <path d="M580 65 H670"/><path d="M580 185 H670"/><path d="M580 305 H670"/>
    <path d="M870 65 C 900 65 900 185 910 185"/><path d="M870 185 H910"/><path d="M870 305 C 900 305 900 185 910 185"/>
  </g>
