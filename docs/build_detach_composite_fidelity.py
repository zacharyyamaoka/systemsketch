...
<p class=\"lede\">A real right-click journey covers an ordinary Block, a Branch, a For Loop, and a semantic connection. The Loop offers the same command as the other authored containers; Branch and Loop become fresh stock Groups with a materialised stock rectangle, so their full port rings stay unclipped in the same movable stock tree. This pass uses the authored effective text sizes (including the 36px Block heading and 11px active/turn labels), 18px port rings, aligned rules, and the active target’s two stock ellipses.</p>
<div class=\"note\"><strong>How to read these pixels.</strong> The browser captured the same canvas rectangle immediately before and after the actual context-menu action. The deterministic heat map measures visual continuity; it is evidence, not a claim that a materialised stock Group is pixel-identical to a custom authored surface. See <a href=\"stock-tldr-capabilities-2026-09-03.html\">the stock capability audit</a> and the <a href=\"detach-primitives-stress-2026-09-03.html\">50-case stress gallery</a> for the tested boundary. The requested <code>/llm-judge</code> command was not available in this workspace.</div>
<div class=\"facts\"><div class=\"fact\"><b>4 / 4</b>live menu workflows completed</div><div class=\"fact\"><b>0</b>shape Error fallbacks or console errors</div><div class=\"fact\"><b>stock only</b>arrow · group · geo · line · text</div></div>
...
<p>The composite metric weights whole-crop continuity, subject foreground, and edge detail. Structural assertions additionally require every original semantic subject to be gone, replacement Branch/Loop stock Groups to exist, and the live page to report no console errors.</p>
