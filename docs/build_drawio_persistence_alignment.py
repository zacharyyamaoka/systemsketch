...
REVIEW_ITEMS = [
    ...
    },
    {
        ...
        "evidence": (
            ...
            "console errors. The full check is also green: 93 files / 793 TypeScript tests plus 92 Python tests."
        ),
...
<body>
  <header class="hero shell">
    ...
    <div class="meta-row">
      <span>13 independently reviewable decisions</span><span>9 implemented/proof items</span><span>2 intentional divergences</span><span>2 bounded deferrals</span><span>93 files · 793 TS + 92 Python tests green</span><span>browser journey green</span><span>file:// ready</span>
    </div>
  </header>
