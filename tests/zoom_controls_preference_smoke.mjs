...
async function main() {
  ...
  try {
    ...
    assert(
      enabled.stored === '{"version":1,"showZoomButtons":true,"directWheelZoom":false,"scrollDownZoomsIn":true,"modifierWheelZoomsOppositely":false,"wheelZoomSensitivityPercent":100,"punctuatedPortRow":true}',
