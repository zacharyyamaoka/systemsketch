...
async function main() {
	...
	try {
		...
		await clickCenter(page, '[data-testid="systemsketch-appearance-panel-codeWidth"] [data-value="64"]')
		await waitFor(page, 'window.__systemsketch.editor.getCurrentPageShapes().find((shape) => shape.type === \'code\')?.props.characterWidth === 64', '64 ch preset')
